<template>
    <div class="loginContainer">
        ...
        <form class="loginForm" v-if="loginWay"><!--短信登录-->
        ...
        <form class="loginForm" v-else><!--密码登录-->
            <section class="input_container">
        ...
        <router-link to="/forget" class="to_forget" v-if="!loginWay">重置密码？</router-link><!--登陆页才显示重置密码-->
