    ...
    export default {
        ...
        methods:{
            ...
            postpois(){
                ...
                if (this.inputVaule) {
                    searchplace(this.cityid, this.inputVaule).then(res => {
                        ...
                        this.placelist = res;
                        this.placeNone = res.length? false : true; /*为空显示空列表*/
                    })
                }
            },
            /**
            ...
            nextpage(index, geohash){
                ...
                let choosePlace = this.placelist[index];//this.placelist 搜索列表
                if (history) {
                ...
                setStore('placeHistory',this.placeHistory) //存进localstorge的placeHistory是一个数组列表。
